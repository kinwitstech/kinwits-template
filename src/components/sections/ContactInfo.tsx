          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-2">+61 383 767 284</p>
                <a 
                  href="mailto:hello@kinwitstech.com"
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          {showMap && (
            <div className="mt-12 w-full h-[400px] bg-secondary/30 rounded-lg overflow-hidden animate-fade-in">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.835434509374!2d144.95373531531652!3d-37.81720997975171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0x5045675218ce7e0!2sMelbourne%20VIC%2C%20Australia!5e0!3m2!1sen!2s!4v1234567890123!5m2!1sen!2s"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-background/10 hover:bg-background/20 flex items-center justify-center transition-colors"
              >
                <Twitch className="w-4 h-4 text-background" />
              </a>
              <a 
                href="https://wa.me" 
                target="_blank" 

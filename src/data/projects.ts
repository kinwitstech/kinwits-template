import prometheusImg from "@/assets/prometheus.png";
import patientPortalImg from "@/assets/patient-portal.png";
import abstractFlow from "@/assets/abstract-flow.svg";
import abstractLayout from "@/assets/abstract-layout.svg";
...
export const projects: Project[] = [
  {
    ...
    title: "bVital Prometheus AI Agent",
    client: "bVital",
    category: "AI & Agents",
    summary:
    ...
    problem:
      "bVital needed a scalable way to generate personalized treatment plans for Parkinson's patients — a process that was manual, time-intensive, and inconsistent across providers. Clinical teams spent hours per patient assembling data from disconnected systems before a plan could even be drafted.",
    solution:
